...
import '../../controllers/firebae_service.dart';
  ...
  Future<void> _createAccount(context) async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (userCredential != null) {
        ...
        await firebaseService.updateDisplayName(_namesController.text);
        await firebaseService
            .createFirestoreDocument(userCredential.user!.uid, {
          'displayName': _namesController.text,
          'licence-key': '',
        ...
        AwesomeDialog(
          ...
          desc:
              'Your account has been created successfully, proceed to subscription screen',
          btnOkOnPress: () {
